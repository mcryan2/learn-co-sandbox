...
def option_b
  ...
  puts "give me a verb that ends in ed."
  verb1 = gets.chomp 
  puts "give me the name of a place"
  place1 = gets.chomp
  puts = "add a verb"
  verb2 = gets.chomp
  puts = "add an adjective"
  adjective = gets.chomp
  puts = "add a time of day"
  timeofday = gets.chomp
  puts = "add an adjective (preferably bad)"
  adjective1 = gets.chomp
  
  
  puts "We were on our way to the grocery store when we ran into #{person1}! We were so excited #{verb1} that we stopped and stared at them for a little while. We eventually started talking. They said that they were on their way to #{place1} and that I was welcome to come if I wanted to. I accepted the invitation and #{verb2} to where they were going. When we got there, it was so #{adjective} there. It was #{timeofday} and it just looked amazing.The problem was that it smelled very #{adjective1}"
end
